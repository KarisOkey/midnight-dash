...
export default function (THREE) {
  ...
  add(B(0.20, 0.06, 0.006), SCUFF, 0.08, 0.06, D / 2 + 0.002, 0, 0, 0, c);
  c = crate(0.03, 0.30, -0.02, -0.10, RED, RED2);
  add(B(0.18, 0.05, 0.006), INNER, -0.10, 0.06, D / 2 + 0.002, 0, 0, 0, c);
  add(B(0.08, 0.03, 0.006), INNER, 0.12, 0.05, D / 2 + 0.002, 0, 0, 0.4, c);
  c = crate(-0.02, 0.60, 0.02, 0.07, GREEN, GREEN2);
  add(B(0.22, 0.05, 0.006), SCUFF, -0.06, 0.07, D / 2 + 0.002, 0, 0, 0, c);
  add(B(W - 0.05, 0.02, D - 0.05), INNER, 0, 0.16, 0, 0, 0, 0, c);
