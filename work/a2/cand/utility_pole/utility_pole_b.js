...
export default function (THREE) {
  ...
  lathe([V2(0, 0), V2(0.19, 0), V2(0.19, 0.5), V2(0.17, 0.55), V2(0.165, 1.5), V2(0.175, 1.52), V2(0.175, 1.58), V2(0.16, 1.6),
    ...
    V2(0.11, 8.95), V2(0.1, 9.0), V2(0, 9.0)], 12, concrete, 0, 0, 0);
  lathe([V2(0.195, 0), V2(0.2, 0), V2(0.2, 0.08), V2(0.195, 0.08)], 12, black, 0, 0, 0);                  // grounding band
  lathe([V2(0.192, 0.1), V2(0.197, 0.1), V2(0.197, 0.5), V2(0.192, 0.5)], 12, concreteStain, 0, 0, 0);    // splash stain
  lathe([V2(0.17, 0.55), V2(0.176, 0.55), V2(0.176, 0.95), V2(0.17, 0.95)], 12, yellow, 0, 0, 0);          // yellow band
  lathe([V2(0.15, 3.0), V2(0.16, 3.0), V2(0.16, 3.4), V2(0.15, 3.4)], 12, concreteStain, 0, 0, 0);          // a stain from the bolt
  for (const y of [5.6, 6.9, 7.6]) lathe([V2(0.128, y), V2(0.142, y), V2(0.142, y + 0.05), V2(0.128, y + 0.05)], 12, rust, 0, 0, 0);
  ...
  const insGeo = new THREE.LatheGeometry([V2(0, 0), V2(0.03, 0), V2(0.055, 0.02), V2(0.06, 0.06), V2(0.04, 0.08), V2(0.06, 0.1), V2(0.065, 0.14), V2(0.045, 0.16), V2(0.06, 0.18), V2(0.06, 0.22), V2(0.035, 0.26), V2(0.03, 0.3), V2(0, 0.3)], 8);
  ...
  for (const [y, len, zo] of arms) {
    ...
    for (const s of [1, -1]) {
      const x = s * (len / 2 - 0.1);
      cyl(0.03, 0.03, 0.3, 6, x, y - 0.04, zo, galv);
      add(insGeo, white, x, y + 0.06, zo);
      cyl(0.03, 0.03, 0.05, 6, x, y + 0.34, zo, rust);
  ...
  lathe([V2(0, 0), V2(0.28, 0), V2(0.32, 0.02), V2(0.32, 0.06), V2(0.3, 0.08), V2(0.3, 0.72), V2(0.32, 0.74), V2(0.32, 0.8), V2(0.28, 0.82), V2(0.15, 0.86), V2(0.05, 0.88), V2(0, 0.88)], 14, drum, 0.55, 6.15, 0);
  for (const [x, z] of [[0.45, 0.1], [0.65, -0.1]]) add(new THREE.LatheGeometry([V2(0, 0), V2(0.035, 0), V2(0.04, 0.05), V2(0.03, 0.08), V2(0.04, 0.12), V2(0.025, 0.18), V2(0, 0.18)], 6), white, x, 7.0, z);
  ...
  cyl(0.012, 0.012, 1.4, 4, 0.5, 5.9, 0.15, cable, 0.3, 0, 0);
  ...
  // --- lamp arm (tube) and an extruded lamp head --------------------------------------------------
  {
    ...
    add(new THREE.CylinderGeometry(0.2, 0.22, 0.03, 10), lamp, 1.7, 5.885, 0);      // the lit dish underneath
