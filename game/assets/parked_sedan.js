// parked_sedan — WINNER (arm B: profiles). The lower body is the side elevation drawn as a Shape (wheel
...
export default function (THREE) {
  ...
  for (const s of [-1, 1]) {
    ...
    add(B(0.03, 0.44, 0.03), GRILL, s * 0.735, 0.62, -0.42); add(B(0.03, 0.44, 0.03), GRILL, s * 0.735, 0.62, 0.5); add(B(0.03, 0.44, 0.03), GRILL, s * 0.735, 0.62, -1.24);  // door seams
    add(B(0.02, 0.32, 0.86), s < 0 ? FADED : PAINT, s * 0.815, 0.62, -0.85);            // one faded rear door
    add(B(0.03, 0.03, 0.12), CHROME, s * 0.825, 0.74, -0.25); add(B(0.03, 0.03, 0.12), CHROME, s * 0.825, 0.74, -1.08);
    add(B(0.03, 0.03, 3.5), CHROME, s * 0.815, 0.52, 0);
